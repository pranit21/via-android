...
public class MainActivity extends AppCompatActivity {
    ...
    private List<ItemObjects> getListItemData(){
        ...
        listViewItems.add(new ItemObjects("Phenol", R.drawable.two));
        listViewItems.add(new ItemObjects("Carbonxylic", R.drawable.three));
        listViewItems.add(new ItemObjects("Nitril", R.drawable.sample_2));
